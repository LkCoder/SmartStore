...
public class UVCCamera {
    ...
    public static final int DEFAULT_PREVIEW_HEIGHT = 360;
    public static final int DEFAULT_PREVIEW_MODE = 0;
    public static final int DEFAULT_PREVIEW_MIN_FPS = 1;
    public static final int DEFAULT_PREVIEW_MAX_FPS = 30;
    public static final float DEFAULT_BANDWIDTH = 0.5f;//1.0f
    ...
    public static final int PU_FACE_OR_SCAN = 0x80080000;    // D19:scan face mode
    ...
    public synchronized void open(final UsbControlBlock ctrlBlock) {
        ...
        if (mNativePtr != 0 && TextUtils.isEmpty(mSupportedSize)) {
            ...
            if (mSupportedSize != null)
                Log.i(TAG, "feiling open nativeGetSupportedSize:" + mSupportedSize.toString());
        }
...
//================================================================================
    ...
    public synchronized void setFaceOrScan(final int Face) {
        Log.i("UVCCamera feiling", " setFaceOrScan Facemode=" + Face);
        if (mNativePtr != 0) {
            nativeSetScanningMode(mNativePtr, Face);
        }
    }

    public synchronized void setFaceOrScan2(final int Face) {
        Log.i("UVCCamera feiling", " setFaceOrScan2 set_cur Facemode=" + Face);
        if (mNativePtr != 0) {
            nativeSetScanningMode2(mNativePtr, Face);
        }
    }


    public synchronized int getFaceOrScan(final int brightness_abs) {
        int result = 0;
        if (mNativePtr != 0) {
//			nativeUpdateScanningModeLimit(mNativePtr);
        }
        return result;
    }


    public synchronized int getFaceOrScan() {
        return getFaceOrScan(nativeGetScanningMode(mNativePtr));
    }

    public synchronized int getFaceOrScan2() {
        int result = 0;//
        nativeGetScanningMode2(mNativePtr);
        return result;
    }
...
//**********************************************************************
    ...
    private static final native int nativeSetScanningMode2(final long id_camera, final int scanning_mode);

    private static final native int nativeGetScanningMode2(final long id_camera);
