...
//**********************************************************************
    ...
    public static final File getCaptureFile(final String type, final String ext) {
		//final File dir = new File(Environment.getExternalStoragePublicDirectory(type), DIR_NAME);//sdcard/mario-file/
		final File dir = new File("sdcard/mario-file", DIR_NAME);
