 ...
 */
package com.baidu.idl.main.facesdk.paymentlibrary.api;
...
import com.baidu.idl.main.facesdk.paymentlibrary.model.Group;
import com.baidu.idl.main.facesdk.paymentlibrary.model.ImportFeatureResult;
...
public class FaceApi {
    ...
    public ImportFeatureResult getFeature(Bitmap bitmap, byte[] feature, BDFaceSDKCommon.FeatureType featureType) {
        ...
        BDFaceImageInstance cropInstance = FaceSDKManager.getInstance().getFaceCrop()
                .cropFaceByLandmark(imageInstance, faceInfo.landmarks, 2.0f, true, new AtomicInteger());
